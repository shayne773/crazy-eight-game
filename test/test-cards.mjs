...
describe('cards', () => {
  ...
  describe.only('deal', () => {
    ...
    it.only('gives back specified hands and new deck with less cards', () => {
      const numHands = 3;
    ...
    it.only('does not modify original deck passed in; gives back new deck', () => {
      const originalDeck = cards.generateDeck();
  ...
  */
  ...
  describe.only('handToString', () => {
    ...
    it.only('gives back only a rank and suit if there is a single card in the hand', () => {
    ...
    it.only('can take a separator as an argument to replace the spaces (for example, newline would format the string as a vertical column)', () => {
      const hand = [
        {suit: SPADES, rank: '3'}, 
        {suit: HEARTS, rank: '2'}, 
        {suit: HEARTS, rank: 'J'}, 
    ...
    it.only('can prefix each card with the position number (starting at 1) and a colon and a space (for example 1: ) by passing in true for the last parameter', () => {
      const hand = [
        {suit: SPADES, rank: '3'}, 
        {suit: HEARTS, rank: '2'}, 
        {suit: HEARTS, rank: 'J'}, 
    ...
    it.only('can prefix each card with the position number and modify the separators (in this example, a vertical column, with each card prefixed by a number)', () => {
      const hand = [
        {suit: SPADES, rank: '3'}, 
        {suit: HEARTS, rank: '2'}, 
        {suit: HEARTS, rank: 'J'}, 
  ...
  */
  ...
  describe.only('matchesAnyProperty', () => {
    ...
    it.only('returns true if any prop and value pair in obj matches any prop and value pair in matchObj (in this case, matches rank)', () => {
      const matchObj = {suit: SPADES, rank: '3'};
      expect(cards.matchesAnyProperty({suit: HEARTS, rank: '3'}, matchObj)).to.be.true;
    });

    it.only('returns false if no prop and value pairs in obj matches any prop and value pairs in matchObj', () => {
      const matchObj = {suit: SPADES, rank: '3'};
      expect(cards.matchesAnyProperty({suit: HEARTS, rank: 'A'}, matchObj)).to.be.false;
    });
  });

  describe.only('drawUntilPlayable', () => {
    ...
    it.only('draws card from deck until an 8... or a rank or suit is matched (in this case, match suit), the last card drawn (end of array) is the match', () => {
      const matchObj = {suit: HEARTS, rank: '9'};
    ...
    it.only('draws card from deck until an 8... or a rank or suit is matched (in this case, match rank)', () => {
      const matchObj = {suit: HEARTS, rank: '9'};
    ...
    it.only('draws card from deck until an 8.... or a rank or suit is matched (in this case, match 8)', () => {
      const matchObj = {suit: HEARTS, rank: '9'};
    ...
    it.only('draws all cards from deck (leaves deck empty) if no 8, rank, or suit is matched', () => {
      const matchObj = {suit: HEARTS, rank: '9'};
